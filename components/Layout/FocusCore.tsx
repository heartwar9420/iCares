...
export default function FocusCore() {
  ...
  // 用一個物件把所有模式的時間對應好
  const timeConfigs = {
    work: `${timerDurationConfigs.work_time_minutes}:00`,
    long_rest: `${timerDurationConfigs.long_rest_time_minutes}:00`,
    rest: `00:${timerDurationConfigs.short_rest_time_seconds}`,
  };
    ...
    <div className="flex flex-col items-center justify-between h-full relative ">
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full ">
        ...
        <div className="text-center">
          <div className="text-[180px] tracking-tight text-white">
            <>
              {displayMinutes}
              {/* animate-pulse = 呼吸燈 */}
      ...
      {/* 熱力圖 */}
      <div className="w-full shrink-0 h-auto min-h-60 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl p-4 flex items-center justify-center">
        <FocusMatrix />
      </div>
    </div>
  );
